<?php
	...
	class Gjmail extends CI_Controller{
		...
		public function trash(){
	    	...
	    	$this->load->view('admin/templates/header');
			$this->load->view('admin/templates/sidebar');
			$this->load->view('admin/mail/delete', $data);
			$this->load->view('admin/templates/footer');
		}
		public function trashsent(){
	    	...
	    	$this->load->view('admin/templates/header');
			$this->load->view('admin/templates/sidebar');
			$this->load->view('admin/mail/deletesent', $data);
			$this->load->view('admin/templates/footer');
		}
		...
		public function reply_mail(){
			...
			$send_data['h:Reply-To'] = $from_email;
		...
		public function deletemailpermanent($id)
		{
			...
			foreach($ids as $id)
			{
				$this->mail_model->deletemailpermanent($id);
			}
			redirect("gjmail/trash");
		}
		public function deletesentmail($id)
		{
			...
			redirect("gjmail/trashsent");
		}
		public function deletesentmailpermanent($id)
		{
			$ids = explode("-",$id);
			foreach($ids as $id)
			{
				$this->mail_sent_model->deletemailpermanent($id);
			}
			redirect("gjmail/trashsent");
		}
	} 
